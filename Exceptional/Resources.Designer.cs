...
namespace ReSharper.Exceptional {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to (optional) The &apos;{0}&apos; exception is not documented in XML documentation. [Exceptional].
        /// </summary>
        internal static string HighlightNotDocumentedOptionalExceptions {
            get {
                return ResourceManager.GetString("HighlightNotDocumentedOptionalExceptions", resourceCulture);
            }
        }
